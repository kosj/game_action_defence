...
const HOT_DRAW := [
	...
	"res://scripts/Orb.gd",
	"res://scripts/Tesla.gd",
	"res://scripts/GarlicAura.gd",
	"res://scripts/FXBurst.gd",
	"res://scripts/FXLightning.gd",
	"res://scripts/Ultimate.gd",
	"res://scripts/TeslaCoil.gd",
	"res://scripts/FlySwarm.gd",
	"res://scripts/BossArena.gd",
	"res://scripts/SteamVent.gd",
	"res://scripts/ToxicPool.gd",
	"res://scripts/CryoVent.gd",
	"res://scripts/FallingDebris.gd",
	"res://scripts/BurningCar.gd",
	"res://scripts/GroundHazard.gd",
	"res://scripts/Drone.gd",
	"res://scripts/EnemyBullet.gd",
	"res://scripts/Boss.gd",
	"res://scripts/BossShell.gd",
	"res://scripts/LandMine.gd",
	"res://scripts/ItemPickup.gd",
	"res://scripts/WeaponPickup.gd",
	"res://scripts/WeatherSystem.gd",
	"res://scripts/Flamethrower.gd",
	"res://scripts/Chainsaw.gd",
	"res://scripts/BoomerangProj.gd",
...
## (노드 하나당 문자열 2회 × 동시 36개 = 실측 드로우 콜 49개).
	...
	for i in lines.size():
		...
		if not (func_exempt or line_exempt):
			for tc in TEXT_CALLS:
				if s.contains(tc + "("):
					_fails.append("%s:%d %s() — 핫 스크립트에서 문자열 드로우. 비트맵으로 굽거나(gen_damage_digits.gd) 예외 사유를 남길 것"
						% [path, i + 1, tc])
					break
