...
export const SETTINGS = {cycle: 0.96, stance: 0.6, reach: 13, lift: 10, hip: 57, bone: 26.5, ankle: 7, lateral: 10};
...
export function poseAt(phase, idle=false) {
  ...
  const legs=[0,1].map(i=>{
    const f=idle?{x:0,z:0,contact:true}:footAt(p+i*.5), lateral=i===0?-SETTINGS.lateral:SETTINGS.lateral;
