...
| A. 무기 12종 | 🟡 8/12 | gun·orb·lightning·garlic·holy + **산탄총·기관총·석궁**(Phase 2-C 배치1). 남은 스펙: 화염방사기/화염병/지뢰/못배트/체인소/터렛/드론/테슬라 |
...
- **[진행] 2-C 신규 무기(재매핑 + 확장):** 스펙 12종으로 확장.
  ...
  - **[남음] 배치 2:** 장판/투척(화염방사기·화염병·지뢰) — 신규 동작 모듈(장판 Area/투척 포물선/설치 폭발).
  - **[남음] 배치 3:** 근접 원호(못배트·체인소) — 회전 원호 히트박스 모듈.
  - **[남음] 배치 4:** 설치물(터렛·드론·테슬라) — 배치형/추종형 자동사격, lightning→테슬라 흡수.
  - **[남음] 기존 흡수·재매핑:** gun/orb/garlic/holy 를 스펙 12종에 흡수하고 기존 id→스펙 id 매핑
    테이블로 세이브 호환. (배치 1은 신규 id라 세이브 충돌 없음 — 매핑은 흡수 시점에.)

### ▶ 다음: Phase 2-C 배치 2(장판/투척 3종) 또는 2-B(스탯 곡선 데이터화)
