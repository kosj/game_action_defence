...
| A. 무기 12종 | 🟡 13/12 | 산탄총·기관총·석궁 + 화염방사기·화염병·지뢰 + **못배트·체인소**(배치3) + 기존 orb·garlic·holy·lightning·gun. 남은 스펙: 터렛/드론/테슬라(배치4, lightning 흡수 포함) |
...
### ▶ 다음: Phase 2-C 배치 4(설치물: 터렛·드론·테슬라) 또는 2-B(스탯 곡선 데이터화)
