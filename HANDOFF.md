...
| P1-4 이벤트 예고 UI | E | ✅ (이 PR) | claude/e-lane-event-forecast | 2026-08-18 |
| P1-5 후반 이속 밸런스 | F | ⚪ 대기 | — | — |
| P1-9 텔레메트리(로컬 수집) | F | ✅ (17df85c) | claude/f-lane-telemetry | 2026-08-18 |
| P1-10 텔레메트리 원격 수집 | — | 🟡 결정대기 | — | — |
| P1-11 기록 내보내기 상시 노출 + 치트 판 표시 | F | 🔵 진행중 | claude/f-lane-telemetry-export | 2026-08-18 |
...
**권고** — 서두르지 않아도 된다. 로컬 수집만으로도 **본인 플레이 데이터로 AI 측정을 검증**할 수
있고, 그게 지금 가장 급한 질문이다(`BALANCE.md` 의 모든 결론에 "AI 기준" 단서가 붙어 있다).
