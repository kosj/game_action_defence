...
| P1-18 후반 성능 — 후반에 fps 18까지 떨어진다 | F | 🔵 진행중 | claude/f-lane-lategame-perf | 2026-08-20 |
...
**⚠️ 겹침 주의** — `scripts/Telemetry.gd` 를 P0-10 과 함께 건드린다. 레인 C 지만
계측 변경분은 P0-10 머지 뒤에 시작한다.
