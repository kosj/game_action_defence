...
| P1-4 이벤트 예고 UI | E | ⚪ 대기 | — | — |
| P1-5 후반 이속 밸런스 | F | ⚪ 대기 | — | — |
| P1-9 텔레메트리(로컬 수집) | F | 🔵 진행중 | claude/f-lane-telemetry | 2026-08-18 |
...
**남은 것 / 주의**
- **사람 검증이 필요하다.** 오토플레이는 보스 접촉 회피에 특히 서툴고 그건 사람이 학습으로
  해결하는 기술이다 — 사람 기준으로는 과교정일 수 있다. 필요하면 회차별 차등화(첫 보스만 0).
