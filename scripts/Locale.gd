...
const STRINGS: Dictionary = {
	...
	"spin_hint":         {"en": "Spin for a random upgrade!", "ko": "돌려서 랜덤 업그레이드 획득!", "ja": "回して ランダム強化を獲得！"},
	"spin_btn_fmt":      {"en": "SPIN  (-%dG)", "ko": "스핀  (-%dG)", "ja": "スピン （-%dG）"},
	"spin_spinning":     {"en": "Spinning...", "ko": "돌리는 중...", "ja": "回転中…"},
	"spin_insufficient": {"en": "Not enough gold", "ko": "골드 부족", "ja": "ゴールド不足"},
	"spin_result_fmt":   {"en": "Got: %s!", "ko": "%s 획득!", "ja": "%s 獲得！"},
	"pick_intro":        {"en": "Draw cards for a random upgrade!", "ko": "카드를 뽑아 랜덤 강화 획득!", "ja": "カードを引いてランダム強化！"},
	"pick_hint":         {"en": "Pick a card!", "ko": "카드를 선택하세요!", "ja": "カードを選んで！"},
	"pick_draw_fmt":     {"en": "DRAW  (-%dG)", "ko": "뽑기  (-%dG)", "ja": "引く （-%dG）"},
